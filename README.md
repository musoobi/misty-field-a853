...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/misty-field-a853)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/misty-field-a853
```

A live public deployment of this template is available at [https://misty-field-a853.templates.workers.dev](https://misty-field-a853.templates.workers.dev)
